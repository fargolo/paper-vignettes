...
SymbolicInference.persistence_barcode(ts_ma_max_d; range = collect(0.1:0.1:0.9), n_windows=60,alpha_thresh=0.0001)
...
rec_matrix_motifs_joint = SymbolicInference.rec_matrix_motifs(
    rec_matriz_joint; window_range=collect(1:60),n_motifs=5)

coordinates_joint =  SymbolicInference.extract_recurrences_joint(ts_raw_unit_d, ts_raw_unit_p, rec_matrix_motifs_joint; num_windows=300) 

SymbolicInference.plot_motifs_joint(ts_raw_unit_d, ts_raw_unit_p,
    coordinates_joint;n_motifs=5)


## 1 to 15 weeks
rec_matrix_motifs_joint = SymbolicInference.rec_matrix_motifs(
    rec_matriz_joint; window_range=collect(1:15),n_motifs=5)

coordinates_joint =  SymbolicInference.extract_recurrences_joint(ts_raw_unit_d, ts_raw_unit_p, rec_matrix_motifs_joint; num_windows=75)
...
## 20 to 30 weeks
rec_matrix_motifs_joint = SymbolicInference.rec_matrix_motifs(
    rec_matriz_joint; window_range=collect(20:30),n_motifs=5)

coordinates_joint =  SymbolicInference.extract_recurrences_joint(ts_raw_unit_d, ts_raw_unit_p, rec_matrix_motifs_joint; num_windows=55)
...
## 40 to 50 weeks
rec_matrix_motifs_joint = SymbolicInference.rec_matrix_motifs(
    rec_0matriz_joint; window_range=collect(40:50),n_motifs=5)

coordinates_joint =  SymbolicInference.extract_recurrences_joint(ts_raw_unit_d, ts_raw_unit_p, rec_matrix_motifs_joint)
