...
rec_matriz_joint = RecurrenceAnalysis.JointRecurrenceMatrix(ts_raw_unit_d, ts_raw_unit_p, 0.2; fixedrate=true)
...
SymbolicInference.plot_motifs_joint(ts_raw_unit_d, ts_raw_unit_p,
    coordinates_joint;n_motifs=6)

#  MA
rec_matriz_joint_ma = RecurrenceAnalysis.JointRecurrenceMatrix(ts_ma_unit_d, ts_ma_unit_p, 0.6; fixedrate=true)
rec_matrix_ma_motifs_joint = SymbolicInference.rec_matrix_motifs(rec_matriz_joint_ma; max_window=100)
...
coordinates_ma_joint;n_motifs=6)
...
coordinates_cross_ma;n_motifs=7)