...
res_infs_d = pmap(x -> double_inference(x;seqs = "double"),res_recs)
res_infs_p = pmap(x -> double_inference(x;seqs = "poincare"),res_recs)
res_infs_r = pmap(x -> double_inference(x;seqs = "recurrences"),res_recs)
